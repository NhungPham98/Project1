			...
			<div class="container">
				...
				<div class="row">
					...
					if(isset( $_SESSION['sanpham1']) && isset( $_SESSION['sanpham2'])){
							$sqp= $_SESSION['sanpham1']["id"];
							$sp2= $_SESSION['sanpham2']["id"];
						
							$k->xuatketquasosanh(" SELECT * FROM product where masp = $sqp " );
						
							$k->xuatketquasosanh(" SELECT * FROM product where masp = $sp2 ");
					...
					?>
                       ...
                       <form>
								<button class="newsletter-btn" name="xoa"> hoàn tất so sánh</button>
							</form>
                          </div>
					</div>
                    <?php  	$k->xoasosanh();?>
